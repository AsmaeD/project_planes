...
print(airport_data)
#Noms de villes manquants, que l'on retrouve dans le nom de la compagnie. A compléter.
...
print(routes_data)
#Voir si les variables correspondent à celles présentes dans les autres dataframes. Bien comprendre la signification de chaque variable
